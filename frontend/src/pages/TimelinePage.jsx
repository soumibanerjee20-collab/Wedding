...
const TimelinePage = () => {
  return (
    <div className="min-h-screen pt-20 relative">
      {/* Background Image - Edinburgh Cityscape */}
      <div 
        className="fixed inset-0 bg-cover bg-center bg-no-repeat"
        style={{
          backgroundImage: `url('https://images.unsplash.com/photo-1454537468202-b7ff71d51c2e?w=1920&q=80')`,
        }}
      >
        {/* Overlay */}
        <div className="absolute inset-0 bg-[#faf8f4]/78" />
      </div>
