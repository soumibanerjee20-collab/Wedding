...
const INVITE_MESSAGE = (name) => 
  `Hi ${name}! After months apart, thousands of miles between us, and more video calls than we can count, the wait is finally over. We're getting married on September 9, 2026! Nothing would make our day more special than having you by our side. Your presence means the world to us. Celebrate with us: https://soumiandjameswedding.netlify.app`;
