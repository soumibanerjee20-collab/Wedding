  ...
  groom: {
    ...
    members: [
      ...
      },
      {
        ...
        description: "Traveled to England and formed an immediate, loving mother-daughter bond with Soumi. Already excited about future grandchildren."
      },
      {
        name: "Patrick Adams",
    ...
    landmarks: [
      {
        ...
        description: "Majestic mountain peaks reflected in pristine alpine lakes. A 4-hour drive from Casper, but absolutely worth the journey."
      },
      {
        name: "National Historic Trails Center",
        description: "Immersive exhibits on four historic trails with panoramic views of Casper Mountain and 500 acres of outdoor exploration."
      },
      {
        name: "Fort Caspar Museum",
        description: "Reconstructed 1860s military fort showcasing the region's pioneer and military history."
      },
      {
    ...
    landmarks: [
      {
        ...
        description: "A magnificent white marble monument built in 1906-1921, now a museum set in 64 acres of beautiful gardens. Kolkata's most iconic landmark."
      },
      {
        name: "Howrah Bridge",
        description: "The iconic cantilever bridge over the Hooghly River. Built in 1943 without nuts or bolts, it's an engineering marvel and symbol of Kolkata."
      },
      {
        name: "Indian Museum",
        description: "The oldest and largest museum in India, founded in 1814. Home to rare artifacts, Egyptian mummies, and archaeological treasures."
      },
      {
        name: "Dakshineswar Kali Temple",
        description: "A famous Hindu temple dedicated to Goddess Kali, where the saint Ramakrishna Paramahansa served as a priest."
      },
      {
        name: "Park Street",
        description: "The heart of Kolkata's food and nightlife scene. Colonial-era buildings, iconic restaurants like Peter Cat and Mocambo, and vibrant energy."
      },
      {
        name: "Princep Ghat",
        description: "A beautiful riverside promenade with Palladian-style architecture, perfect for evening walks along the Hooghly River."
      }
    ]
  },
  accommodation: {
